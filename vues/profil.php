                ...
                <div id="profil-post">
                    ...
                    <div class="post-perso" id="post<?php echo $line_posts["IDPost"]; ?>">
                        <div class="main-post">
                            ...
                            <div class="text-post">
                                <?php
                                    if($_GET["id_profil"] == $_SESSION["id"] OR $line_posts["idAuteur"] == $_SESSION["id"]){
                                ?>
                                <div class="lien-modif-post">
                                    ...
                                    <div class="overlay-modif-post">
                                        <a class="lien-suppr-post" href="index.php?action=supprPost&id=<?php echo $line_posts["IDPost"]; ?>&page=accueil&idProfil=<?php echo $_GET["id_profil"]; ?>">Supprimer</a>
                                    </div>
                                </div>
                                <?php
                                    }
                                ...
                                <div class="main-commentaire">
                                    ...
                                    <div class="lien-modif-comment">
                                        ...
                                        <div class="overlay-modif-comment">
                                            <a class="lien-suppr-comment" href="index.php?action=supprCommentaire&id=<?php echo $line_comments["IDComment"]; ?>&page=profil&idProfil=<?php echo $_GET["id_profil"]; ?>&postId=<?php echo $line_posts["IDPost"]; ?>">Supprimer</a>
                                        </div>
                                    </div>
                                    <?php        
                                        }
